          ...
          <div className="rounded-xl p-6">
            ...
            <div className="flex flex-wrap gap-2">
              {techstack.map((tech, index) => (
                <Motion.span
                  key={index}
                  className="bg-blue-500/10 text-blue-500 px-3 py-1 rounded-full text-sm hover:bg-blue-500/30 hover:shadow-[0_2px_8px_rgba(59, 130, 2246, 0.2)] transition-all duration-300"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              <h3 className="text-xl font-bold mb-4 flex gap-3 items-center"> 
                 ...
                 <ul className="list-disc list-inside space-y-2">
                    <li>
                        <strong className="text-lg font-semibold">MSc in Data Science</strong><strong></strong>
                        <p className="text-gray-400">University of Glasgow, 2024</p>
                    </li>
                    <li>
                        <strong className="text-lg font-semibold">BE in Information Technology</strong><strong></strong>
            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              <h3 className="text-xl font-bold mb-4 flex gap-3 items-center">
                 ...
                 <ul className="list-disc list-inside space-y-2">
                    <li>
                        <strong className="text-lg font-semibold">Capgemini</strong><strong></strong>
                        <p className="text-gray-400">University of Glasgow, 2024</p>
                    </li>
                    <li>
                        <strong className="text-lg font-semibold">BE in Information Technology</strong><strong></strong>
